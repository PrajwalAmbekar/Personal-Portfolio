    ...
    <aside className='bg-[#1F2B3E] w-1/4 h-[650px] rounded-3xl'>
      <div className=' text-white flex  flex-col items-center gap-10 pt-16 '>
        <div className='flex flex-col text-center items-center gap-4'>
          <div className='bg-[#1F3A5F] w-28 h-28 rounded-xl '>
            <img src={Profile_pic} alt="profile_pic" className='rounded-xl p'/>
          </div>
        ...
        <div className='w-8 h-8 bg-[#1F3A5F] rounded-lg flex justify-center items-center hover:scale-125'>
