  ...
  return (<>
    ...
    <div className='fixed h-[650px] w-3/4 bg-[#1F2B3E] rounded-3xl  p-10 flex flex-col gap-4' style={{
      ...
      <div className='flex flex-col gap-10'>
        ...
        <p className='font-serif text-[#ACC2EF] w-[900px]' style={{
          "text-indent": "100px"
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='flex flex-col  gap-6'>
          <div className='bg-[#1F3A5F]  flex gap-6 p-8 rounded-3xl w-[925px] cursor-pointer'>
            <div className='flex gap-6'>
              <div className='w-16 h-16 bg-[#0F1C2E] rounded-lg flex justify-center items-center '><TbCode className='text-[#cd0131]/70 text-3xl' />
              </div> {/**Image */}
            </div>
          ...
          <div className='flex flex-row gap-6'>
            <div className='bg-[#1F3A5F] flex gap-6 p-8 rounded-3xl w-[450px] cursor-pointer '>
              <div className='flex gap-6'>
                <div className='w-16 h-16 bg-[#0F1C2E] rounded-lg flex justify-center items-center'>
                <MdDesignServices  className='text-[#cd0131]/70 text-3xl'/></div> {/**Image */}
            ...
            <div className='bg-[#1F3A5F]  flex gap-6 p-8 rounded-3xl w-[450px] cursor-pointer'>
              <div className='flex gap-6'>
                <div className='w-16 h-16 bg-[#0F1C2E] rounded-lg flex justify-center items-center'><IoLogoWebComponent className='text-[#cd0131]/70 text-3xl'/></div> {/**Image */}
